...
export class ModifyTypeScreen extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    firebase
      ...
      .get()
      .then((snapshot) => {
        let userTypes = snapshot.data().type;
        this.setState({ type: userTypes });
      });
  };
...
export default function (props) {
  ...
  return <ModifyTypeScreen {...props} navigation={navigation} />;
}
