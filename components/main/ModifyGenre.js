...
export class ModifyGenreScreen extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    firebase
      ...
      .get()
      .then((snapshot) => {
        let userGenres = snapshot.data().genre;
        this.setState({ genre: userGenres });
      });
  };
...
export default function (props) {
  ...
  return <ModifyGenreScreen {...props} navigation={navigation} />;
}
